...
include("metis-backend:metis-personal:metis-personal-domain")
include("metis-backend:metis-personal:metis-personal-application")
include("metis-backend:metis-personal:metis-personal-adapters")